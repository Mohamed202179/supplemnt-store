                ...
                <div key={group.id} className="rounded-2xl bg-white shadow-sm">
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-gray-400">{group.categories?.name || "بدون تصنيف"}</p>
                        ...
                        <div key={p.id} className="rounded-xl bg-gray-50 p-3">
                          ...
                          <div className="mt-1 flex items-center justify-between text-sm">
                            <span className="text-gray-500">
                              الكمية: <b className="text-gray-800">{p.current_stock}</b>
                            </span>
                          ...
                          <div className="mt-2 flex gap-2">
                            <Link
                              ...
                              className="flex-1 rounded-lg bg-white py-2 text-center text-xs font-semibold text-gray-700 border border-gray-200"
                            >
                              تعديل
                            </Link>
                            <button
