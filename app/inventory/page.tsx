...
import { ChevronLeft, ChevronUp, ChevronDown, ShoppingBag, Package } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="space-y-3 p-4">
        <div className="flex items-center justify-between rounded-2xl bg-white dark:bg-gray-900 p-4 shadow-sm dark:bg-gray-900">
          <div>
          ...
          <Link href="/products" className="flex shrink-0 items-center gap-1 rounded-xl bg-gray-100 dark:bg-gray-800 px-3 py-2 text-xs font-bold text-gray-700 dark:text-gray-300">
            إدارة المنتجات
        ...
        <input
          ...
          className="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-3 text-sm shadow-sm focus:border-brand-500 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100"
        />

        {loading ? (
          <p className="py-10 text-center text-sm text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">جارِ التحميل...</p>
        ) : isEmpty ? (
          <div className="py-10 text-center">
            <p className="text-sm text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">لا توجد منتجات بعد</p>
          ...
          <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
                ...
                <div key={group.id} className="rounded-2xl bg-white dark:bg-gray-900 shadow-sm">
                  <button onClick={() => toggleGroup(group.id)} className="flex w-full items-center gap-3 p-3 text-right">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-gray-400 dark:text-gray-500">{variants.length} طعم/حجم</p>
                      <div className="mt-1 flex gap-3 text-xs">
                        <span className="text-gray-500 dark:text-gray-400 dark:text-gray-500">
                          إجمالي الكمية: <b className="text-gray-800 dark:text-gray-200">{totalStock}</b>
                        </span>
                        ...
                        >
                          ...
                          <div className="mt-2 grid grid-cols-2 gap-2 text-center text-xs">
                            <div className="rounded-lg bg-white dark:bg-gray-900 py-1.5">
                              ...
                              <p className="mt-0.5 font-bold text-gray-800 dark:text-gray-200">{p.current_stock}</p>
                            </div>
                            <div className="rounded-lg bg-white dark:bg-gray-900 py-1.5">
                              <p className="text-gray-400 dark:text-gray-500">الإجمالي (تكلفة)</p>
            ...
            {standaloneProducts.map((p) => (
              ...
              >
                ...
                <div className="mt-2 grid grid-cols-3 gap-2 border-t border-gray-100 dark:border-gray-800 pt-2 text-center text-xs">
                  ...
                  <div className="rounded-lg bg-gray-50 dark:bg-gray-800 py-2">
                    ...
                    <p className="mt-0.5 font-bold text-gray-800 dark:text-gray-200">{p.min_stock}</p>
                  </div>
                  <div className="rounded-lg bg-gray-50 dark:bg-gray-800 py-2">
                    <p className="text-gray-400 dark:text-gray-500">الإجمالي (سعر الشراء)</p>
